...
types: Node Types {
  link: /intersect/habits/deep-dive/node-types
  style.fill: "#1a365d"
  style.stroke: "#63b3ed"
...
definition: Create Automation {
  ...
  m1: Workflows-as-Code / Automations-as-Code {
    shape: hexagon
    style.fill: "#975a16"
    style.stroke: "#fbd38d"
  ...
  m3: Convert from n8n/Activepieces {
    shape: hexagon
    style.fill: "#975a16"
    style.stroke: "#fbd38d"
    style.font-color: "#fefcbf"
...
deploy: Deployment Targets {
  link: "/intersect/habits/deep-dive/running.html#packing-distributing"
  style.fill: "#553c9a"
  style.stroke: "#b794f4"
