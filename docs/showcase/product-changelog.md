...
description: "An AI-powered developer utility that translates raw, technical git log outputs into clean, customer-friendly, and well-structured release notes."
aside: false
---
...
const images = [
    { img: '/showcase/product-changelog/product-changelog-2.webp', caption: 'Product Changelog' },
    { img: '/showcase/product-changelog/product-changelog.webp', caption: 'Product Changelog' }
]

const habitTabs = [
    { label: 'product-changelog', url: '/showcase/product-changelog/product-changelog.yaml' }
]
</script>
...
<p class="showcase-description">An AI-powered developer utility that translates raw, technical git log outputs into clean, customer-friendly, and well-structured release notes.</p>

- Bridge the communication gap between your development team and your users. 
- This application accepts raw commit histories or technical git logs between tags, strips away internal refactoring noise, and leverages AI to generate an organized breakdown of new features, bug fixes, and performance improvements written in clear, non-technical language.
...
<ExampleRunner examplePath="product-changelog" />
