...
const images = [
    { img: '/showcase/real-estate-marketing/1.webp', caption: 'Real Estate Marketing' }
]
</script>
...
<div class="showcase-header">
  <div class="showcase-meta">
    <div class="meta-left">
      ...
      <div class="tags"><span class="showcase-tag tag-real-estate"><component :is="Tag" :size="12" /> real-estate</span> <span class="showcase-tag tag-marketing"><component :is="Tag" :size="12" /> marketing</span> <span class="showcase-tag tag-automation"><component :is="Zap" :size="12" /> automation</span> <span class="showcase-tag tag-ai"><component :is="Brain" :size="12" /> ai</span></div>
    </div>
...
<div class="showcase-taxonomy"><div class="taxonomy-group"><span class="taxonomy-label">Industries</span><span class="taxonomy-values"><a href="../industries/real-estate" class="taxonomy-pill">real estate</a></span></div><div class="taxonomy-group"><span class="taxonomy-label">Departments</span><span class="taxonomy-values"><a href="../industries/real-estate#marketing" class="taxonomy-pill">marketing</a></span></div></div>
...
- **Campaign Automation**: launch targeted email campaigns for new listings and events
- **Social Media Posting**: schedule and post listing highlights across social channels
- **Open House Promotion**: send reminders and RSVP tracking for open house events
- **Newsletter Distribution**: compile market updates and distribute to your subscriber list
- **Listing Performance Alert**: alert the marketing team when a listing underperforms
- **Competitor Analysis**: monitor competitor listings and summarise with AI weekly


<div class="habits-grid">
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Campaign Automation</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Launch targeted email campaigns automatically when new listings are published or events are created.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">email</span><span class="bit-badge">ai</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Social Media Posting</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Schedule and post AI-crafted listing highlights across connected social media channels.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">http</span><span class="bit-badge">ai</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Open House Promotion</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Send automated reminders to registered attendees and track RSVPs for open house events.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">email</span><span class="bit-badge">sms</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Newsletter Distribution</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Compile local market updates with AI and distribute the newsletter to your subscriber list.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">email</span><span class="bit-badge">ai</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Listing Performance Alert</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Alert the marketing team when a listing is underperforming on views or enquiry metrics.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">ai</span><span class="bit-badge">slack</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Competitor Analysis</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Monitor competitor listings weekly and produce an AI-generated market intelligence summary.</p>
...
::: code-group
<<< @/../showcase/real-estate-marketing/stack.yaml [stack.yaml]
:::
