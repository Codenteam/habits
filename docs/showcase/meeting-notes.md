---
title: "Meeting Notes"
description: "An AI-powered productivity tool designed to condense lengthy meeting scripts, notes, transcripts into structured, actionable items and summaries."
aside: false
---
...
const images = [
    { img: '/showcase/meeting-notes/meeting-notes-2.webp', caption: 'Meeting Notes' },
    { img: '/showcase/meeting-notes/meeting-notes.webp', caption: 'Meeting Notes' }
]

const habitTabs = [
    { label: 'meeting-notes', url: '/showcase/meeting-notes/meeting-notes.yaml' }
]
</script>
...
<p class="showcase-description">An AI-powered productivity tool designed to condense lengthy meeting scripts, notes, transcripts into structured, actionable items and summaries.</p>

- Transform your team's discussions into concrete next steps. 
- This application captures a raw transcript or meeting script, 
 filters out casual conversations, and utilizes AI to extract 
 key decisions, distribute action items, and generate a concise executive brief.
...
<ExampleRunner examplePath="meeting-notes" />
