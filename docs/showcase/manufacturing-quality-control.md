...
const images = [
    { img: '/showcase/manufacturing-quality-control/1.webp', caption: 'Manufacturing Quality Control' }
]
</script>
...
<div class="showcase-header">
  <div class="showcase-meta">
    <div class="meta-left">
      ...
      <div class="tags"><span class="showcase-tag tag-manufacturing"><component :is="Tag" :size="12" /> manufacturing</span> <span class="showcase-tag tag-quality"><component :is="Tag" :size="12" /> quality</span> <span class="showcase-tag tag-automation"><component :is="Zap" :size="12" /> automation</span> <span class="showcase-tag tag-compliance"><component :is="Tag" :size="12" /> compliance</span></div>
    </div>
...
<div class="showcase-taxonomy"><div class="taxonomy-group"><span class="taxonomy-label">Industries</span><span class="taxonomy-values"><a href="../industries/manufacturing" class="taxonomy-pill">manufacturing</a></span></div><div class="taxonomy-group"><span class="taxonomy-label">Departments</span><span class="taxonomy-values"><a href="../industries/manufacturing#quality-control" class="taxonomy-pill">quality control</a></span></div></div>
...
<div class="habits-grid">
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Defect Report Routing</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Capture defect reports from the production line and route them to the QC team instantly.</p>
  ...
  <div class="habit-card">
    ...
    <p class="habit-description">Schedule quality inspections automatically based on production milestone completions.</p>
  ...
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Non-Conformance Routing</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Route NCRs to the responsible team with deadline assignment and severity classification.</p>
    <div class="bit-list"><span class="bit-badge">webhook</span><span class="bit-badge">email</span><span class="bit-badge">slack</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Corrective Action Tracking</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Monitor CAPA completion progress and send escalating reminders as deadlines approach.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">email</span><span class="bit-badge">http</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Certification Tracking</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Alert the QC manager automatically when product or process certifications are due for renewal.</p>
    <div class="bit-list"><span class="bit-badge">scheduler</span><span class="bit-badge">email</span><span class="bit-badge">http</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Audit Preparation</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Compile evidence packs and assign preparation tasks to the team ahead of scheduled audits.</p>
...
::: code-group
<<< @/../showcase/manufacturing-quality-control/stack.yaml [stack.yaml]
:::
