---
title: "Daily Standup"
description: "AI-powered developer tool that transforms raw task lists into clean, management-ready standup updates."
aside: false
---
...
const images = [
    { img: '/showcase/daily-standup/daily-standup-2.webp', caption: 'Daily Standup' },
    { img: '/showcase/daily-standup/daily-standup.webp', caption: 'Daily Standup' }
]

const habitTabs = [
    { label: 'daily-standup', url: '/showcase/daily-standup/daily-standup.yaml' }
]
</script>
...
<p class="showcase-description">AI-powered developer tool that transforms raw task lists into clean, management-ready standup updates.</p>

- Take your daily development chaos and turn it into structured updates. 
- This application captures raw text inputs, filters out system contexts, 
and leverages AI to generate an organized breakdown of completed tasks, 
current focus areas, and active blockers alongside an executive summary paragraph.
...
<ExampleRunner examplePath="daily-standup" />
