...
const images = [
    { img: '/showcase/real-estate-transaction-management/1.webp', caption: 'Real Estate Transaction Management' }
]
</script>
...
<div class="showcase-header">
  <div class="showcase-meta">
    <div class="meta-left">
      ...
      <div class="tags"><span class="showcase-tag tag-real-estate"><component :is="Tag" :size="12" /> real-estate</span> <span class="showcase-tag tag-transactions"><component :is="Tag" :size="12" /> transactions</span> <span class="showcase-tag tag-automation"><component :is="Zap" :size="12" /> automation</span> <span class="showcase-tag tag-compliance"><component :is="Tag" :size="12" /> compliance</span></div>
    </div>
...
<div class="showcase-taxonomy"><div class="taxonomy-group"><span class="taxonomy-label">Industries</span><span class="taxonomy-values"><a href="../industries/real-estate" class="taxonomy-pill">real estate</a></span></div><div class="taxonomy-group"><span class="taxonomy-label">Departments</span><span class="taxonomy-values"><a href="../industries/real-estate#transaction-management" class="taxonomy-pill">transaction management</a></span></div></div>
...
<div class="habits-grid">
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Offer Tracking</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Notify all transaction parties instantly when a new offer is received or an existing offer is updated.</p>
    <div class="bit-list"><span class="bit-badge">webhook</span><span class="bit-badge">email</span><span class="bit-badge">sms</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Document Collection</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Request outstanding transaction documents from all parties and track receipt status.</p>
  ...
  <div class="habit-card">
    ...
    <p class="habit-description">Coordinate property inspection booking between buyer, seller, and inspector automatically.</p>
  ...
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Closing Coordination</h3>
      <span class="trigger-badge trigger-scheduler">Scheduled</span>
    </div>
    <p class="habit-description">Send closing checklists and deadline reminders to all parties as closing day approaches.</p>
  ...
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Commission Calculation</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Calculate and route commission splits automatically when a deal reaches closing.</p>
    <div class="bit-list"><span class="bit-badge">webhook</span><span class="bit-badge">http</span><span class="bit-badge">email</span></div>
  </div>
  <div class="habit-card">
    <div class="habit-header">
      <h3 class="habit-name">Compliance Review</h3>
      <span class="trigger-badge trigger-webhook">Webhook</span>
    </div>
    <p class="habit-description">Trigger a structured compliance checklist automatically when a transaction enters the contract stage.</p>
    <div class="bit-list"><span class="bit-badge">webhook</span><span class="bit-badge">email</span><span class="bit-badge">http</span></div>
  </div>
</div>
...
::: code-group
<<< @/../showcase/real-estate-transaction-management/stack.yaml [stack.yaml]
:::
