...
description: "An AI-powered validation tool that acts as a devil's advocate, rigorously analyzing product ideas to uncover potential flaws, market risks, and hidden reasons for failure."
aside: false
---
...
const images = [
    { img: '/showcase/idea-validator/idea-validator-2.webp', caption: 'Idea Validator' },
    { img: '/showcase/idea-validator/idea-validator.webp', caption: 'Idea Validator' }
]

const habitTabs = [
    { label: 'idea-validator', url: '/showcase/idea-validator/idea-validator.yaml' }
]
</script>
...
<p class="showcase-description">An AI-powered validation tool that acts as a devil's advocate, rigorously analyzing product ideas to uncover potential flaws, market risks, and hidden reasons for failure.</p>

- Stress-test your business and product concepts before spending time and money. 
- This application takes a raw description of a product idea, bypasses surface-level 
  optimism, and uses AI to perform a critical evaluation of market viability, 
  operational challenges, and structural risks under a strict critique framework.
...
<ExampleRunner examplePath="idea-validator" />
