...
onMounted(async () => {
  try {
    ...
    if (res.ok) {
      ...
      const stats = data.stats['@ha-bits/bit-pouch']
      if (stats) {
        const el = document.querySelector('[data-package="@ha-bits/bit-pouch"] .download-count')
...
<div class="bit-meta">
  ...
  <span class="bit-downloads" data-package="@ha-bits/bit-pouch">📥 <span class="download-count">205</span> downloads</span>
