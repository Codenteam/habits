...
onMounted(async () => {
  try {
    ...
    if (res.ok) {
      ...
      const stats = data.stats['@ha-bits/bit-scheduler']
      if (stats) {
        const el = document.querySelector('[data-package="@ha-bits/bit-scheduler"] .download-count')
...
<div class="bit-meta">
  ...
  <span class="bit-downloads" data-package="@ha-bits/bit-scheduler">📥 <span class="download-count">67</span> downloads</span>
