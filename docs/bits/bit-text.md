...
onMounted(async () => {
  try {
    ...
    if (res.ok) {
      ...
      const stats = data.stats['@ha-bits/bit-text']
      if (stats) {
        const el = document.querySelector('[data-package="@ha-bits/bit-text"] .download-count')
...
<div class="bit-meta">
  ...
  <span class="bit-downloads" data-package="@ha-bits/bit-text">📥 <span class="download-count">211</span> downloads</span>
